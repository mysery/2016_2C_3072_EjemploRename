...
namespace TGC.Group.Physics
{
    public class HelloWorldBullet : PhysicsGame
    {
        ...
        public override void Init(GameModel ctx)
        {
            ...
            ballTransform.Origin = new Vector(0, 50, 0);
            ...
            floorMesh = new TgcPlane(new Vector(-200, 0, -200).ToDxVector, new Vector(400, 0f, 400).ToDxVector, TgcPlane.Orientations.XZplane, floorTexture);
            ...
            sphereMesh = new TgcSphere(1, texture.Clone(), new Vector(0, 0, 0).ToDxVector);
